...
const url =
  "https://api.videasy.to/cdn/sources-with-title?title=The%2520Boys&mediaType=tv&year=2019&episodeId=2&seasonId=1&tmdbId=76479&imdbId=tt1190634";
...
async function runDiagnostics() {
  ...
  try {
    const proxyBase =
      process.env.VIDEASY_PROXY_URL ||
      "https://dreadnought.47qzoobg8k.workers.dev";
    console.log(
