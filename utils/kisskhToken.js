...
(function (_0x2a0650, _0x28a91e) {
  ...
  while (!![]) {
    try {
      const _0x2eca83 =
        (parseInt(_0x3a8d(0x10a)) / 0x1) * (parseInt(_0x3a8d(0x113)) / 0x2) +
        (-parseInt(_0x3a8d(0x10d)) / 0x3) * (parseInt(_0x3a8d(0x116)) / 0x4) +
        (-parseInt(_0x3a8d(0x10c)) / 0x5) * (-parseInt(_0x3a8d(0x11b)) / 0x6) +
        parseInt(_0x3a8d(0x123)) / 0x7 +
        parseInt(_0x3a8d(0x11a)) / 0x8 +
        parseInt(_0x3a8d(0x125)) / 0x9 +
        -parseInt(_0x3a8d(0x11d)) / 0xa;
...
const generateKissKHToken = (function () {
  function _0x1b25b9(_0x3378d3) {
    const _xb = _0x3a8d,
      _len = _0x3378d3[_xb(0x114)],
      _words = [];
    for (let i = 0; i < _len; i++)
      _words[i >>> 0x2] |=
        (0xff & _0x3378d3[_xb(0x121)](i)) << (0x18 - (i % 4) * 0x8);
    return [_words, _len];
  }
  ...
  function _0x1c779c(_words, _len) {
    ...
    for (let i = 0; i < _len; i++) {
      _hex[_xb(0x120)](
        ((_words[i >>> 0x2] >>> (0x18 - (i % 4) * 0x8)) & 0xff)
          [_xb(0x10f)](0x10)
          ["padStart"](0x2, "0"),
      );
    }
  ...
  const _6b = [
    [
      ...
      -0x6c9fb16c, 0x524345c4, -0x66c19cd2, 0x188eead9, -0x351884c7,
      -0x675bc103, 0x19a5dd3, 0x1914b70a, -0x4fb1e313, 0x28ea2210, 0x29707fc3,
      0x3064c8c9, -0x17593e17, -0x3fb31c07, -0x16c363c6, -0x26a7ab0d,
  ...
  (function () {
    ...
    for (let i = 0; i < 0x100; i++) {
      ...
      let v = _2d[i2],
        x = _2d[_2d[v]],
        t = (0x101 * _2d[s]) ^ (0x1010100 * s);
      ((_42[i2] = (t << 24) | (t >>> 8)),
        (_b4[i2] = (t << 16) | (t >>> 16)),
        (_25[i2] = (t << 8) | (t >>> 24)),
        (_5d[i2] = t),
        i2
          ? ((i2 = v ^ _2d[_2d[_2d[x ^ v]]]), (i1 ^= _2d[_2d[i1]]))
          : (i2 = i1 = 1));
    }
  ...
  function _3505d7(words, start) {
    ...
    let iv =
      start === 0
        ? [0x1504af3, 0x56e619cf, 0x2e42bba6, -0x73c08f07]
        : words.slice(start - 4, start);
    for (let i = 0; i < 4; i++) words[start + i] ^= iv[i];
    let w0 = words[start] ^ _45[0],
      w1 = words[start + 1] ^ _45[1],
      w2 = words[start + 2] ^ _45[2],
      w3 = words[start + 3] ^ _45[3],
      cur = 4;
    for (let i = 1; i < 10; i++) {
      let t0 =
        _32[w0 >>> 24] ^
